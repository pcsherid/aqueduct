...
#
# Files:
#	aqueduct/files/aide/aide.conf
#	aqueduct/files/aide/aide.cron
#	aqueduct/files/aide/aidereset.cron
#
# Templates:
#	None
#
...
class aide {
	...
	file {
		"/etc/aide.conf":
			...
			group  => wheel,
			mode   => 600,
			source => "puppet:///modules/aqueduct/aide/aide.conf";
		"/etc/cron.daily/aide":
			owner  => root,
			group  => root,
			mode   => 700,
			source => "puppet:///modules/aqueduct/aide/aide.cron";
		# This will update the AIDE db every week
		#"/etc/cron.weekly/aide":
		#	owner  => root,
		#	group  => root,
		#	mode   => 700,
		#	source => "puppet:///modules/aqueduct/aide/aidereset.cron";
	}
