...
#
# Files:
#	aqueduct/files/rsyslog/syslog.rotate
#
# Templates:
#	aqueduct/templates/rsyslog/rsyslog.conf.erb
#	
# Dependencies:
#	None
############################################################
class rsyslog {
	...
	file {
		"/etc/rsyslog.conf":
			...
			group   => root,
			mode    => 644,
			content => template("aqueduct/rsyslog/rsyslog.conf.erb"),
		...
		"/etc/logrotate.d/syslog":
			...
			group  => root,
			mode   => 444,
			source => "puppet:///modules/aqueduct/rsyslog/syslog.rotate";
	}
}
