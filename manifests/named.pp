...
#
# Files:
#	aqueduct/files/named/named.conf
#	aqueduct/files/named/named.initd
#	aqueduct/files/named/named.sysconfig
#
# Templates:
#	None
#
...
class named::server {
	...
	file {
		...
		#	group   => named,
		#	mode    => 640,
		#	source  => "puppet:///modules/aqueduct/named/named.conf";
		"/etc/sysconfig/named":
			owner   => root,
			group   => root,
			mode    => 644,
			source  => "puppet:///modules/aqueduct/named/named.sysconfig";
		"/etc/init.d/named":
			owner   => root,
			group   => root,
			mode    => 755,
			source  => "puppet:///modules/aqueduct/named/named.initd";
	}
}
